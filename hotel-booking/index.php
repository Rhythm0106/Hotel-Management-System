...
<?php
	...
	//hotels
	$hotels = $conn->query("SELECT * FROM hotels WHERE status = 1"); //Status will detect that hotel is available or not 
	$hotels->execute();

	$allHotels = $hotels->fetchAll(PDO::FETCH_OBJ);

	//rooms
	$rooms = $conn->query("SELECT * FROM rooms WHERE status = 1"); //Status will detect that room is available or not 
	$rooms->execute();
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-7 ftco-animate">
            ...
            <p><a href="#" class="btn btn-primary">Learn more</a> <a href="<?php echo APPURL; ?>/conta" class="btn btn-white">Contact us</a></p>
          </div>
        </div>
      </div>
    </div>
